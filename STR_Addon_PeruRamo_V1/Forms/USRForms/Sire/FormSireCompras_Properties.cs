...
{
    sealed partial class FormSireCompras
    {
        public const string gs_nombre = "FrmRVIEC";
        public const string gs_ruta = "Resources/Sire/FrmRVIEC.srf";
        public const string gs_menu = "MNU_SIRE_RCE";

        //Controles UI
        //ComboBox
        private readonly string lrs_CmbAnios = "cbxAnio";
        private readonly string lrs_CmbMeses = "cbxMeses";
        //Grid  
        private readonly string lrs_GrdCompras = "grdCompra";
        ...
        private readonly string lrs_ClmTipoMode = "Moneda";  // Codigo Moneda
        ...
        private readonly string lrs_BtnDelt = "btnDelete";
        ...
        private readonly string lrs_RbnNoDoc = "rbnNodoc";
        ...
        private readonly string lrs_LblDetalleNodm = "lblNoDomi";
        // SAP
        // Edit Text
